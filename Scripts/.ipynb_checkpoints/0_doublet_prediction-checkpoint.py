...
input_dir = '/home/l538g/workingf/brainbreaks/single_cell_BB_E17-5/fastq/round2/*_result_new'
...
for i in data_dict:
    data_dict[i]="/home/l538g/workingf/brainbreaks/single_cell_BB_E17-5/fastq/round2/"+i+"/outs/filtered_feature_bc_matrix"
    print(data_dict[i])
    
    
outdir="/home/l538g/workingf/brainbreaks/single_cell_BB_E17-5/Giulia_data_analysis/result_all_05082024/Python_files/Results/0_Doublet_prediction/"
for i in data_dict:
    print(i)
